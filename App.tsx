        ...
        <div className="max-w-6xl mx-auto w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
             ...
             <button 
               ...
               className="bg-white/80 hover:bg-white p-2 rounded-full transition-all shadow-sm border border-white/50 group cursor-pointer"
               title="รีเฟรชข้อมูลล่าสุด"
             >
               <span className="text-xl group-hover:rotate-180 transition-transform duration-700 block">🔄</span>
             </button>
